...
def main(show=True):
    ...
    for LSP in LSPs:
        ...
        for year in years:
            ...
            stock.append(LSP_FirstStageReuseYear["NewRecovered"].sum() - LSP_FirstStageReuseYear["ReusedLost"].sum())
        ...
        axes[0].step(years + [years[-1]+1], stock, color='white', where='post', label='Flight-proven stock')
